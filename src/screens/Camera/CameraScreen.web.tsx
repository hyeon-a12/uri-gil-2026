  ...
  const openCamera = useCallback(
    async (nextFacing: 'environment' | 'user') => {
      ...
      try {
        ...
        // 한때 여기서 aspectRatio: 9/16을 명시적으로 강제해봤는데, 일부
        // 기기가 그 비율을 맞추려고 센서 중앙의 좁은 영역만 잘라 보내면서
        // (디지털 줌처럼) 미리보기가 심하게 확대되어 보이는 부작용이 있었습니다.
        // 방향 지정 없이 큰 해상도만 ideal로 요청하면 브라우저가 실제 기기
