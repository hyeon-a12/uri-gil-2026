...
import { Card, ListRow, Badge, type BadgeVariant, cardShadow } from '@/components/common';
import { ScreenHeader } from '@/components/common/ScreenHeader';

// ────────────────────────────────────────────────
// 여행 상태는 DB에 저장하지 않고 날짜로부터 계산합니다.
...
export default function MyRoutesScreen() {
  ...
  return (
    <View style={styles.screen}>
      ...
      <Pressable style={styles.fab} onPress={() => router.push('/(tabs)/my-route')}>
